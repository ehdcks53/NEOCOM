				...
				<div class="row">
					...
					<sec:authorize access="hasAnyRole('ADMIN', 'MANAGER')">
						<div class="ml-md-auto" style="margin-right:20px;">
							<button type="button" id="insertBtn" class="form-control btn-sm btn-outline-info" onclick="location.href='${pageContext.request.contextPath}/admin/community/board_list'">글쓰기 <i class="icon-arrow-right-circle"></i></button>
						</div>
					</sec:authorize>
				</div>
			</form>

			...
			<div class="container padding-top-3x">
				<div class="row justify-content-center align-items-center">
					<div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
						<!-- 제품 브랜드 로고 이미지 여기 -->
						<div class="from-bottom"><img class="d-inline-block w-150 mb-4" src="static/frontend/assets/img/hero-slider/sony-logo.png" alt="">
					...
					<!-- 슬라이더 전체이미지 여기 -->
					<div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="static/frontend/assets/img/hero-slider/sony-headphone-iu4.jpg" alt=""></div>
				</div>
			</div>
		</div>
		<div class="item">
			<div class="container padding-top-3x">
				<div class="row justify-content-center align-items-center">
					...
					<!-- 슬라이더 전체이미지 여기 -->
					<div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="static/frontend/assets/img/hero-slider/sony-headphone-iu1.jpg" alt=""></div>
				</div>
			</div>
		</div>
		<div class="item">
			<div class="container padding-top-3x">
				<div class="row justify-content-center align-items-center">
					...
					<!-- 슬라이더 전체이미지 여기 -->
					<div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="static/frontend/assets/img/hero-slider/sony-headphone-iu2.jpg" alt=""></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-3 col-md-4 col-sm-6">
			<div class="product-card mb-30">
				...
				<!-- productbadge -->
				<a class="product-thumb" href="#"><img src="static/frontend/assets/img/shop/products/01.jpg" alt=""></a>
				...
				<div class="product-button-group">
					...
					<a class="product-button" href="#"><i class="icon-shopping-cart"></i><span>장바구니</span></a>
				</div>
			</div>
		</div>
		<div class="col-lg-3 col-md-4 col-sm-6">
			<div class="product-card mb-30">
				<a class="product-thumb" href="#"><img src="static/frontend/assets/img/shop/products/02.jpg" alt=""></a>
				<div class="product-card-body">
					<div class="product-category"><a href="#">브랜드명</a></div>
		...
		<div class="col-lg-3 col-md-4 col-sm-6">
			<div class="product-card mb-30">
				<a class="product-thumb" href="#"><img src="static/frontend/assets/img/shop/products/05.jpg" alt=""></a>
				<div class="product-card-body">
					<div class="product-category"><a href="#">브랜드명</a></div>
		...
		<div class="col-lg-3 col-md-4 col-sm-6">
			<div class="product-card mb-30">
				<a class="product-thumb" href="#"><img src="static/frontend/assets/img/shop/products/07.jpg" alt=""></a>
				<div class="product-card-body">
					<div class="product-category"><a href="#">브랜드명</a></div>
...
<section class="container padding-top-3x padding-bottom-2x">
	<div class="row">
		<div class="col-md-4 col-sm-6 text-center mb-30">
			<a href="#"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="static/frontend/assets/img/services/02.png" alt=""></a>
			<h6 class="mb-2">교환/환불</h6>
		</div>
		<div class="col-md-4 col-sm-6 text-center mb-30">
			<a href="#"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="static/frontend/assets/img/services/03.png" alt=""></a>
			<h6 class="mb-2">고객센터</h6>
		</div>
		<div class="col-md-4 col-sm-6 text-center mb-30">
			<a href="#"><img class="d-block w-90 img-thumbnail rounded mx-auto mb-4" src="static/frontend/assets/img/services/04.png" alt=""></a>
			<h6 class="mb-2">결제</h6>
		</div>
	</div>
</section>

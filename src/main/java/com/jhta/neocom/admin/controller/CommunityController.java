...
/*	@RequestMapping(value = "/admin/community/noticeboard_list", method = RequestMethod.GET)
	public String noticeboardList(@RequestParam(value = "nn_pageNum",defaultValue = "1") int nn_pageNum,String nn_field,String nn_keyword,Model nn_model,HashMap<String,Object> nn_map) {
		// 공지사항 리스트
	...
	@RequestMapping(value = "/admin/community/qnaboard_list", method = RequestMethod.GET)
	public String qnaboardList(@RequestParam(value = "qq_pageNum",defaultValue = "1") int qq_pageNum,String qq_field,String qq_keyword,Model qq_model,HashMap<String,Object> qq_map) {

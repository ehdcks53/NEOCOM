...
public class FreeBoardController {
	...
	public String freeboard_list(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, 
							String field, String keyword, Model model, HashMap<String, Object> map, Authentication auth) {

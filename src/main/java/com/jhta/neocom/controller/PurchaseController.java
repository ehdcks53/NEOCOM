...
public class PurchaseController {
	...
	public ModelAndView purchase0(int product_count, int product_id, String product_name, int selling_price,
			String img_name_save, String uploadPath, Model model) {
		/*
	...
	public ModelAndView purchase1(HttpSession session, Model model,
			@RequestParam("cart_nos") ArrayList<String> cart_nos) {
		/*
		 * public ModelAndView purchase1(HttpSession session, Model
		 * model, @RequestParam("chkbox") ArrayList<Integer> chkbox,
		 * 
		 ...
		 */
		/*
		 * //int a = Integer.parseInt(chkbox.get(0)); ArrayList<ProductVo> purchaseList
		 * = new ArrayList<ProductVo>(); /*for (int i = 0; i < chkbox.size(); i++) {
		 * purchaseList.addAll(productservice.purchaseList(chkbox.get(i))); }
		 * 
		 * System.out.println(purchaseList);
		 * 
		 * 
		 * mv.addObject("purchaseList", purchaseList); //mv.addObject("cnt", cnt);
		 */
	...
	public ModelAndView purchase(OrderMainVo vo, String[] order_price, String[] product_count, String[] product_id,

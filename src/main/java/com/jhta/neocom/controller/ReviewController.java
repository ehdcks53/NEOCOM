...
public class ReviewController {
	...
	// 문의게시판 수정 페이지 이동
	@RequestMapping(value = "community/review_update", method = RequestMethod.GET)
	...
	// 문의게시판 수정 등록
	@RequestMapping(value = "community/review_update", method = RequestMethod.POST)
	public String review_updateOk() {
	...
	public String review_list(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, String field,
			String keyword, Model model, HashMap<String, Object> map, Authentication authentication) {
...
//			r_service.cntHit(board_num); // 조회수 증가 쿼리
